...
// ---------- 报告底部固定免责声明 ----------
// 蟾先森 CHAN XIAN SEN 品牌口径——所有 AI 报告底部统一追加
export const DISCLAIMER_BLOCK = `
---

**免责声明**

本报告由「蟾先森 CHAN XIAN SEN · AI 国学生活顾问」基于传统历法、民俗文化与心理学框架自动生成，**仅供文化参考、生活规划启发与娱乐参考**，不构成医疗、法律、投资、婚姻、职业等任何专业决策建议。报告可能存在偏差，请以现实判断为准。请勿将本报告作为重大决策的唯一依据；涉及健康、法律、财务等重要事项时，请咨询相应专业人士。
`.trim();
