...
const VERSION = "2026-07-20.qimen-foundation-v1";
...
method("qimen-safety-boundary", 13, "safety_boundary", "产品解释边界",
...
validate();
const output = { version: VERSION, scope: "Qimen Dunjia foundational entities, relations, method boundaries and interpretations", sources: Object.values(SOURCES), entities, relations, methodRules, interpretations };
