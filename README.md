# 卦安 GuaAn · AI 国学生活顾问 · MVP

> 品牌：**卦安 GuaAn** · 副标题：AI 国学生活顾问 · 仓库别名：`ai-fengshui-demo`
>
...
>
> 品牌字面（标题 / Nav / footer / disclaimer）由 [`src/lib/config/brand.ts`](./src/lib/config/brand.ts) 单点维护。
